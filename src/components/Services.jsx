...
const Services = () => {
  return (
    ...
    <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am a Frontend & Data Integration Developer from India, with 2 years of experience in KNS Technologies.</p>
    ...
    <div className="grid grid-cols-auto gap-6 my-10">
        ...
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <p className="text-sm text-gray-600 leading-5 dark:text-white/80">Web development is the process of building, programming...</p>
        ...
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <h3 className="text-lg my-4 text-gray-700 dark:text-white">Database</h3>
            <p className="text-sm text-gray-600 leading-5 dark:text-white/80">Proficient in managing relational databases and writing complex queries....</p>
            <a href="" className="flex items-center gap-2 text-sm mt-5">Read more <img src={right_arrow} alt="" className="w-4"/></a>
        </div>
        <div className="border border-gray-400 rounded-lg px-8 py-12
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            <img src={ui_icon} alt="" className="w-10"/>
            <h3 className="text-lg my-4 text-gray-700 dark:text-white">Data Integration</h3>
            <p className="text-sm text-gray-600 leading-5 dark:text-white/80">Proficient in designing and implementing complex integrations using Boomi's visual interface...</p>
            <a href="" className="flex items-center gap-2 text-sm mt-5">Read more <img src={right_arrow} alt="" className="w-4"/></a>
        </div>
        <div className="border border-gray-400 rounded-lg px-8 py-12
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
