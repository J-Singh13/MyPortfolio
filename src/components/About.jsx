...
import user_image from '../assets/My_img.jpg'
  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
            <p className="mb-10 max-w-2xl font-Ovo">I am an experienced Data Integration and Frontend Developer with over a decade of professional expertise in the field. Throughout my career, I have had the privilege of collaborating with prestigious organizations, contributing to their success and growth.</p>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                ...
                ">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">HTML, CSS, JavaScript, React Js, Python, Data Integration </p>
                </li>
